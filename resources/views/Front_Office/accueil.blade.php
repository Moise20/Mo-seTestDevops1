            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/airpods2.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image">
                        <div class="card-body">
                            <p class="card-text">airpods2. <br>description airpods2.</p>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/apple watch serie 4.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image">
                        <div class="card-body">
                            <p class="card-text">apple watch serie 4<br>description apple watch serie 4 </p>
                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/apple watch serie 8.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image">
                        <div class="card-body">
                            <p class="card-text">apple watch serie 8 <br>description apple watch serie 8 </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="price">129.00 €</span>
                                <a href="#" class="btn btn-sm btn-outline-secondary"><i class="fas fa-eye"></i></a>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/iphone 14.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image">
                        <div class="card-body">
                            <p class="card-text">iphone 14 <br>description iphone 14 </p>
                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/iphone 11 pro max.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image">
                        <div class="card-body">
                            <p class="card-text">iphone 11 pro max <br>description iphone 11 pro max </p>
                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/iphone x.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image">
                        <div class="card-body">
                            <p class="card-text">iphone x <br>description iphone x </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="price">1029.00 €</span>
                                <a href="#" class="btn btn-sm btn-outline-secondary"><i class="fas fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/iphone7.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image">
                        <div class="card-body">
                            <p class="card-text">iphone7 <br>description iphone7</p>
                            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/iphone 14 pro max.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image">
                        <div class="card-body">
                            <p class="card-text">iphone 14 pro max<br>description iphone 14 pro max </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="price">1029.00 €</span>
                                <a href="#" class="btn btn-sm btn-outline-secondary"><i class="fas fa-eye"></i></a>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img src="{{asset('produits/iphone xs.jpeg')}}" class="card-img-top img-fluid" alt="Responsive image" >
                        <div class="card-body">
                            <p class="card-text">iphone xs <br>description iphone xs</p>
                            <div class="d-flex justify-content-between align-items-center">
